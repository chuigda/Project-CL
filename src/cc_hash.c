...
static inline
cc_uint64 *cc_hash_uint128_low(cc_hash_uint128 *x) {
    return &x->data[PROJECT_CL_IS_BIG_ENDIAN()];
}

static inline
cc_uint64 *cc_hash_uint128_high(cc_hash_uint128 *x) {
    return &x->data[!PROJECT_CL_IS_BIG_ENDIAN()];
}

#ifndef __SIZEOF_INT128__
static inline
void cc_hash_full_mul(cc_uint64 op1, cc_uint64 op2,
...
static inline
cc_hash_uint128 cc_hash_uint128_multiply(cc_hash_uint128 a, cc_hash_uint128 b) {
    cc_hash_uint128 result;
#ifdef __SIZEOF_INT128__
    result.whole_data = a.whole_data * b.whole_data;
#else
    cc_uint64 hi, lo;
    cc_hash_full_mul(*cc_hash_uint128_low(&a), *cc_hash_uint128_low(&b),
                         &hi, &lo);
...
static inline
cc_hash_uint128 cc_hash_cast_uint64_to_uint128(cc_uint64 low) {
...
static inline
cc_uint64 cc_hash_swap_bytes64(cc_uint64 x) {
...
static inline
cc_uint32 cc_hash_swap_bytes32(cc_uint32 x) {
...
static inline
cc_uint16 cc_hash_swap_bytes16(cc_uint16 x) {
...
static inline
cc_hash_uint128 cc_hash_load_uint128le(const void *data) {
...
static inline
cc_uint64 cc_hash_load_uint64le(const void *data) {
    cc_uint64 value;
...
static inline
cc_uint32 cc_hash_load_uint32le(const void *data) {
    cc_uint32 value;
    PROJECT_CL_HASH_GENERIC_LOAD(&value, data);
    if (PROJECT_CL_IS_BIG_ENDIAN()) {
...
static inline
cc_uint16 cc_hash_load_uint16le(const void *data) {
    cc_uint16 value;
    PROJECT_CL_HASH_GENERIC_LOAD(&value, data);
    if (PROJECT_CL_IS_BIG_ENDIAN()) {
...
static inline
cc_uint64 cc_hash_rotate_left(cc_uint64 x, cc_uint64 y) {
...
static inline
cc_uint64 cc_hash_folded_multiply(cc_uint64 x, cc_uint64 y) {
...
static inline
void cc_hash_stable_digest128(cc_stable_hasher *hasher, cc_hash_uint128 data) {
    cc_uint64 low = *cc_hash_uint128_low(&data);
    cc_uint64 high = *cc_hash_uint128_high(&data);
    cc_uint64 combined = cc_hash_folded_multiply(low ^ hasher->extra_keys[0], high ^ hasher->extra_keys[1]);
    hasher->buffer = cc_hash_rotate_left((hasher->buffer + hasher->pad) ^ combined, PROJECT_CL_STABLE_HASH_ROTATE);
}
...
cc_uint64 cc_finalize_stable_hasher(const cc_hasher *hasher) {
    ...
    return cc_hash_rotate_left(cc_hash_folded_multiply(shasher->buffer, shasher->pad), rot);
}

static inline
cc_uint64 cc_hash_stable_mix_integer(cc_stable_hasher hasher, cc_uint64 x, cc_uint64 y) {
...
void cc_stable_hasher_digest(cc_hasher *hasher, const void *input, cc_size length) {
    ...
    shasher->buffer = (shasher->buffer + length) * PROJECT_CL_STABLE_HASH_MULTIPLE;
...
static inline void cc_simd_hash_digest_hashvec(cc_simd_hasher *hasher, cc_hashvec state) {
    hasher->enc = cc_hash_simd_encode(hasher->enc, state);
    hasher->sum = cc_hash_simd_shuffle_add(hasher->sum, state);
}

static inline void cc_simd_hash_digest_hashvec2(cc_simd_hasher *hasher, cc_hashvec x, cc_hashvec y) {
...
static inline
cc_uint64 cc_finalize_simd_hasher(const cc_hasher *hasher) {
...
static inline
cc_uint64 cc_hash_simd_mix_integer(cc_simd_hasher hasher, cc_uint64 x, cc_uint64 y) {
...
static inline
void cc_initialize_simd_hasher(cc_hasher *hasher, cc_uint64 seed) {
...
static inline
void cc_simd_hasher_digest(cc_hasher *hasher, const void *input, size_t length) {
    cc_simd_hasher *vhasher = (cc_simd_hasher *) hasher;
    const cc_uint8 *data = (const uint8_t *) input;
    vhasher->enc = cc_hash_simd_lower_add(vhasher->enc, length);
    if (length <= 8) {
        cc_hash_small_data value = cc_hash_load_small_data(data, length);
        cc_simd_hash_digest_hashvec(vhasher, cc_hash_simd_u64x2(value.data[0], value.data[1]));
    } else {
        if (length > 32) {
            if (length > 64) {
#  if PROJECT_CL_HASH_HAS_WIDE_SIMD
